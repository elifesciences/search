...
abstract class BlogArticleWorkflowTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->workflow = new BlogArticleWorkflow($this->getSerializer(), new NullLogger(), $this->elastic);
    }
    ...
    public function testInsertOfBlogArticle(BlogArticle $blogArticle)
    {
        ...
        $return = $this->workflow->insert($this->workflow->serializeArticle($blogArticle), 'blog-article', $blogArticle->getId());
